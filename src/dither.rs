            ...
            for j in 0..IMG_WIDTH {
                ...
                for k in 0..2 {
                    for n in 0..3 {
                        ...
                        if (j as isize + n as isize - 1) < 0 || n + j >= IMG_WIDTH {
                            continue;
                        }

                        error_buff[out_index + k * IMG_WIDTH + n - 1] -= error * kernel[k][n] / 16;
                    }
